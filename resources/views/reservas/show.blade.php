...
@section('content')
  <div class="header header-filter text-center" style="background-image: url('https://images.unsplash.com/photo-1526392060635-9d6019884377?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80');">
...
<div class="main main-raised">
	...
	<span class="sr-only">30% Complete(warning)</span>
        ...
        <div class="col-sm-8">
        <div class="col-sm-4"><button class="btn btn-success" href="{{ url('/login') }}">Continuar</button></div>
